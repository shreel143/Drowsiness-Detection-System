'''This script extracts a list of 25 songs of each genre from Spotify's database using Spotify API'''
...
for g in tqdm(genres):
    ...
    for track in recs:
        ...
        # Wait 0.1 seconds per track so that the api doesnt overheat
        time.sleep(0.1)
